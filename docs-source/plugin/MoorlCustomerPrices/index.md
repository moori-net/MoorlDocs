...
- [https://demo-sw67.moori.net/MoorlCustomerPrices](https://demo-sw67.moori.net/MoorlCustomerPrices)
...
Gehen Sie zu **„Einstellungen → [Demo Assistent](../MoorlFoundation/demo-assistant.md)“** und wählen Sie dort **„MoorlCustomerPrices“** aus.
